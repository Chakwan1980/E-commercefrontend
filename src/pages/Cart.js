...
const Cart = () => {
    ...
    const handleIncrease = (product_code) => {
        updateProductQuantity(product_code, 1); 
    };
    ...
    const handleRemove = (product_code) => {
        removeProductFromCart(product_code); 
    };
                        ...
                        return (
                            <li key={item.product_code} className="product-item">
                                ...
                                <div className="product-info">
                                    ...
                                    <button className="remove-button" onClick={() => handleRemove(item.product_code)}> <img src={Eliminar} width={20}  alt={item.product_name}  /> </button>
                                </div>
                            </li>
                        );
                    })}
